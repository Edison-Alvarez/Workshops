"""
This is a set of classes to get an answer for the workshop 2 of Software Design course.

Author: Edison David Alvarez
Update: 2020-09-23 by Edison David Alvarez
"""
...
class Engine:  
    ...
    def __init__(self, name_engine: str, type_engine: str, potency_engine: int, weight: float, gama: str, stability: str, dimensions: str, torque: str, maximun_speed: float):
        ...
        self.__dimesions = dimensions
        self.__torque = torque
        self.__maximun_speed = maximun_speed
